...
import { PROFILE, ANIMATION_DELAYS } from '@/constants';
...
const NameWithVine: React.FC<NameWithVineProps> = () => {
  return (
    <span className="relative block animate-text-bloom" style={{ animationDelay: ANIMATION_DELAYS.nameText }}>
      <span className="relative z-10 font-extrabold">
        <GradientText>{PROFILE.name}</GradientText>
      </span>
      
      <div className="absolute -bottom-6 left-0 w-full flex justify-center">
        <svg width="400" height="40" viewBox="0 0 400 40" className="animate-draw-vine">
          <path 
          ...
          />
          <g className="animate-leaf-appear" style={{ animationDelay: '2s' }}>
